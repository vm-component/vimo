...
function isValidStub(stub) {
  return (
    ...
    (typeof stub === "string" ||
      stub === true ||
      (typeof stub === "object" && typeof stub.render === "function"))
  )
}
    ...
    Object.keys(stubs).forEach(function(stub) {
      ...
      if (component.components[stub]) {
        ...
        if (typeof stubs[stub] === "string") {
          component.components[stub] = createStubFromString(
            stubs[stub],
        ...
        if (typeof stubs[stub] === "string") {
          component.components[stub] = Object.assign(
            {},
            vueTemplateCompiler.compileToFunctions(stubs[stub])
          )
          stubLifeCycleEvents(component.components[stub])
        } else {
          component.components[stub] = Object.assign({}, stubs[stub])
...
function isDomSelector(selector) {
  ...
  try {
    if (typeof document === "undefined") {
      throwError(
        "mount must be run in a browser environment like PhantomJS, jsdom or chrome"
      )
    }
  } catch (error) {
    throwError(
...
WrapperArray.prototype.hasAttribute = function hasAttribute(attribute, value) {
  ...
  return this.wrappers.every(function(wrapper) {
    return wrapper.hasAttribute(attribute, value)
  })
}
...
WrapperArray.prototype.hasClass = function hasClass(className) {
  ...
  return this.wrappers.every(function(wrapper) {
    return wrapper.hasClass(className)
  })
}
...
WrapperArray.prototype.hasProp = function hasProp(prop, value) {
  ...
  return this.wrappers.every(function(wrapper) {
    return wrapper.hasProp(prop, value)
  })
}
...
WrapperArray.prototype.hasStyle = function hasStyle(style, value) {
  ...
  return this.wrappers.every(function(wrapper) {
    return wrapper.hasStyle(style, value)
  })
}
...
WrapperArray.prototype.findAll = function findAll() {
  ...
  throwError(
    "findAll must be called on a single wrapper, use at(i) to access a wrapper"
  )
}
...
WrapperArray.prototype.find = function find() {
  ...
  throwError(
    "find must be called on a single wrapper, use at(i) to access a wrapper"
  )
}
...
WrapperArray.prototype.html = function html() {
  ...
  throwError(
    "html must be called on a single wrapper, use at(i) to access a wrapper"
  )
}
...
WrapperArray.prototype.name = function name() {
  ...
  throwError(
    "name must be called on a single wrapper, use at(i) to access a wrapper"
  )
}
...
WrapperArray.prototype.text = function text() {
  ...
  throwError(
    "text must be called on a single wrapper, use at(i) to access a wrapper"
  )
}

WrapperArray.prototype.throwErrorIfWrappersIsEmpty = function throwErrorIfWrappersIsEmpty(
  method
) {
...
ErrorWrapper.prototype.update = function update() {
  throwError(
    "find did not return " +
      this.selector +
      ", cannot call update() on empty Wrapper"
  )
}
...
Wrapper.prototype.hasStyle = function hasStyle(style, value) {
  ...
  if (
    ...
    console.warn(
      "wrapper.hasStyle is not fully supported when running jsdom - only inline styles are supported"
...
Wrapper.prototype.find = function find(selector) {
  if (!isValidSelector(selector)) {
    throwError(
      "wrapper.find() must be passed a valid CSS selector or a Vue constructor"
    )
  }
...
Wrapper.prototype.findAll = function findAll(selector) {
  ...
  if (!isValidSelector(selector)) {
    throwError(
      "wrapper.findAll() must be passed a valid CSS selector or a Vue constructor"
    )
  }
  ...
  if (typeof selector === "object") {
    ...
    return new WrapperArray(
      components.map(function(component) {
        return new VueWrapper(component, this$1.options)
      })
    )
  }
  ...
  return new WrapperArray(
    matchingNodes.map(function(node) {
      return new Wrapper(node, this$1.update, this$1.options)
    })
  )
}
...
Wrapper.prototype.is = function is(selector) {
  if (!isValidSelector(selector)) {
    throwError(
      "wrapper.is() must be passed a valid CSS selector or a Vue constructor"
    )
  }
...
function addSlotToVm(vm, slotName, slotValue) {
  if (Array.isArray(vm.$slots[slotName])) {
    if (typeof slotValue === "string") {
      vm.$slots[slotName].push(
        vm.$createElement(vueTemplateCompiler.compileToFunctions(slotValue))
      )
    } else {
...
function addProvide(component, options) {
  var provide =
    typeof options.provide === "function"
      ? options.provide
  ...
  options.beforeCreate = function vueTestUtilBeforeCreate() {
    this._provided =
      typeof provide === "function" ? provide.call(this) : provide
  }
}
...
function mount(component, options) {
  ...
  var componentToMount =
    options.clone === false ? component : lodash.cloneDeep(component)
  // Remove cached constructor
