...
describe('App', function () {
  ...
  it('@base: renders the correct markup', function () {
    ...
    const result = `<article version="${window.VM.version}" class="ion-app ios platform-ios"><section class="app-root"><span>Name</span></section> <aside id="modalPortal"></aside> <aside id="sheetPortal"></aside> <aside id="alertPortal"></aside> <aside id="loadingPortal"></aside> <aside id="toastPortal"></aside> <aside class="click-block click-block-enabled"></aside> </article>`
