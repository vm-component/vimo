<template>
    <vm-page>
        ...
        <vm-content padding>
            ...
            <vm-img width="100%" height="200" :src="'https://raw.githubusercontent.com/vm-component/vimo/master/examples/static/background/'+i+'.jpg'" v-for="i in totalCount"
                 :key="i"></vm-img>
        </vm-content>
    </vm-page>
</template>
