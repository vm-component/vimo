...
(function () {
  ...
  var Swiper = function (container, params) {
    ...
    function autoplay () {
      ...
      s.autoplayTimeoutId = window.setTimeout(function () {
        if (s.params.loop) {
          s.fixLoop();
          s._slideNext();
          s.emit('onAutoplay', s);
    ...
    s.stopAutoplay = function (internal) {
      ...
      if (s.autoplayTimeoutId) window.clearTimeout(s.autoplayTimeoutId);
      s.autoplaying = false;
      s.autoplayTimeoutId = undefined;
    ...
    s.scrollbar = {
      ...
      dragEnd: function (e) {
        ...
        sb.isTouched = false;
        if (s.params.scrollbarHide) {
          window.clearTimeout(sb.dragTimeout);
          sb.dragTimeout = window.setTimeout(function () {
      ...
      setTranslate: function () {
        ...
        if (s.params.scrollbarHide) {
          ...
          sb.timeout = window.setTimeout(function () {
            sb.track[0].style.opacity = 0;
            sb.track.transition(400);
          }, 1000);
        }
    ...
    function handleMousewheel (e) {
      ...
      if (!s.params.freeMode) {
        ...
        if (s.params.freeModeSticky) {
          window.clearTimeout(s.mousewheel.timeout);
          s.mousewheel.timeout = window.setTimeout(function () {
            s.slideReset();
          }, 300);
        }
        else {
