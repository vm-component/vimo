!function (win, bridge) {
  if ('function' == typeof define && (define.amd || define.cmd)) {
    ...
    var preVerifyOptions, preVerifyOptionsReverse, doc, docTitle, userAgent, platform, isPC, isWxDebugger, isWechat,
      isAndroid, isIos, clientVersion, isReportSended, isErrorBefore, initTimeRecord, jsSdkReportInfo, configOptions,
      preVerifyJSAPIConfig, initResult, jsApiList
    if (!window.jWeixin) {
      // 面相用户和app之间命名冲突的部分
      preVerifyOptions = {
